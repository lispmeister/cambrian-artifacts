"""Pydantic models for manifest, viability report, generation records."""
...
class ViabilityCheckResult(BaseModel):
    passed: bool
    duration_ms: int | None = None


class TestCheckResult(ViabilityCheckResult):
    tests_run: int | None = None
    tests_passed: int | None = None


class ViabilityChecks(BaseModel):
    manifest: ViabilityCheckResult
    build: ViabilityCheckResult
    test: TestCheckResult
    start: ViabilityCheckResult
    health: ViabilityCheckResult
