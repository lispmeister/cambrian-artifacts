...
class SupervisorClient:
    ...
    async def _get(self, path: str) -> Any:
        ...
        while True:
            try:
                ...
                log.warning("supervisor_get_error", component="prime",
                            path=path, error=str(exc), retry_in=delay)
    ...
    async def _post(self, path: str, body: dict[str, Any]) -> Any:
        ...
        while True:
            try:
                ...
                log.warning("supervisor_post_error", component="prime",
                            path=path, error=str(exc), retry_in=delay)
                await asyncio.sleep(delay)
                delay = min(delay * 2, max_delay)
    ...
    async def spawn(
        ...
        """POST /spawn — request Test Rig spawning."""
        body = {
            "spec-hash": spec_hash,
